...
public class PostController extends BaseController {
    ...
    public String posts(Model model,
        ...
        model.addAttribute("publishCount", postService.getCountByStatus(PostStatusEnum.PUBLISHED.getCode(), PostTypeEnum.POST_TYPE_POST.getDesc()));
        model.addAttribute("draftCount", postService.getCountByStatus(PostStatusEnum.DRAFT.getCode(), PostTypeEnum.POST_TYPE_POST.getDesc()));
        model.addAttribute("trashCount", postService.getCountByStatus(PostStatusEnum.RECYCLE.getCode(), PostTypeEnum.POST_TYPE_POST.getDesc()));
