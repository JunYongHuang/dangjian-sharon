...
public class AdminController extends BaseController {
    ...
    public String index(Model model) {
        ...
        //查询最新的文章
        List<Post> postsLatest = postService.findPostLatest(PostTypeEnum.POST_TYPE_POST.getDesc());
        model.addAttribute("postTopFive", postsLatest);
        //查询最新的文章
        List<Post> specialsLatest = postService.findPostLatest(PostTypeEnum.POST_TYPE_SPECIAL.getDesc());
        model.addAttribute("specialTopFive", specialsLatest);
