...
public class AttachmentServiceImpl implements AttachmentService {
    ...
    public Map<String, String> attachUpload(MultipartFile file, HttpServletRequest request) {
        ...
        try {
            ...
            if (!mediaPath.exists()) {
                if (!mediaPath.mkdirs()) {
                    log.error("File upload failed: " + uploadPath.toString() + ", isExist: " + mediaPath.exists());
//                    resultMap.put("success", "0");
    ...
    @Override
    public List<Attachment> findByWhiteIdAndPostId(Long whiteId, Long postId) {
        return attachmentRepository.findByWhiteIdAndPostId(whiteId, postId);
    }

    @Override
    public List<Attachment> findByWhiteIdAndPostIdOrZero(Long whiteId, Long postId) {
        return attachmentRepository.findByWhiteIdAndPostIdOrZero(whiteId, postId);
    }

    @Override
    public Page<Attachment> findAllByAdmin( Pageable pageable) {
        return attachmentRepository.findAllByAdmin( pageable);
    }
