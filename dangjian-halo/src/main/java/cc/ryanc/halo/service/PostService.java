...
public interface PostService {
     ...
     * @return Post
     */
    Post save(Post post, List<String> cateList);
     ...
     * @return List
     */
    List<Post> findPostLatest(String postType);
     ...
     * @return List
     */
    List<Archive> findPostGroupByYear(String postType);
     ...
     * @return List
     */
    List<Post> findPostByYear(String year, String postType);
     ...
     * @return Page
     */
    Page<Post> findPostByCategoriesAndPostType(Category category, String postType, Pageable pageable);
     ...
     * @return 文章数量
     */
    Integer getCountByStatus(Integer status, String postType);
     ...
     * @return Post Post
     */
    Post buildSpecialTypes(Post post, Long specialTypeId);

    Page<Post> findPostBySpecialType(SpecialType specialType, Pageable pageable);

    Page<Post> findByRoleIdAndStatus(Integer roleId, int status, String postType, Pageable pageable);

    Page<Post> findPostByWhite(White white, Pageable pageable);
