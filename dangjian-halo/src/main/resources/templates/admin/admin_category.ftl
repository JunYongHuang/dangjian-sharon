                    ...
                    <#if updateCategory??>
                        ...
                        <form action="/admin/category/save" method="post" role="form" id="cateAddForm">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="roleId">关联:</label>

                                        <select class="form-control" id="roleId" name="roleId">
                                            <option value="-1">请选择</option>
                                            <option value="1" <#if (updateCategory.roleId!0)==1>selected</#if>>党委</option>
                                            <option value="2" <#if (updateCategory.roleId!0)==2>selected</#if>>党支部</option>
                                        </select>
                                    <small>选择党委或党支部后，发文如果选择对应目录将自动向对应人员发送待办事项</small>
                        ...
                        <form action="/admin/category/save" method="post" role="form" id="cateAddForm" onsubmit="return checkCate()">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <small>选择党委或党支部后，发文如果选择对应分类将自动向对应人员发送待办事项</small>
