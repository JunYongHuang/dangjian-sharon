                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-sm-8">
                                            <input type="text" class="form-control" id="whiteName" name="whiteName" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8 control-radio">
                                            <div class="pretty p-default p-round">
                                                <input type="radio" name="loginEnable" id="loginEnable" value="true" checked>
                                                <div class="state p-primary">
                                                    <label>启用</label>
                                                </div>
                                            </div>
                                            <div class="pretty p-default p-round">
                                                <input type="radio" name="loginEnable" id="loginEnable" value="false" >
                                                <div class="state p-primary">
                                                    <label>禁用</label>
                                                </div>
                                            </div>
