...
<@head>${options.blog_title!} | <@spring.message code='admin.meetings.edit.title' /></@head>
<div class="content-wrapper">
    ...
    <section class="content-header" id="animated-header">
        <h1 style="display: inline-block;"><@spring.message code='admin.meetings.edit.title' /></h1>
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a data-pjax="true" href="/admin/meetings"><@spring.message code='admin.meetings.title' /></a>
            </li>
            <li class="active"><@spring.message code='admin.meetings.edit.title' /></li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div style="margin-bottom: 10px;">
                    <input type="text" class="form-control input-lg" id="postTitle" name="postTitle" placeholder="<@spring.message code='admin.meetings.edit.form.title.placeholder' />" onblur="autoComplateUrl();" value="${post.postTitle!}">
                </div>
                <div style="display: block;margin-bottom: 10px;">
                    <span>
                        <@spring.message code='admin.editor.form.url' />
                        <a href="javascript:void(0)">${options.blog_url!}/meetings/<span id="postUrl">${post.postUrl!}</span>/</a>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.code==1){
                        ...
                        halo.showMsgAndRedirect(data.msg,'success',1000,'/admin/meetings');
                    }else{
                        halo.showMsg(data.msg,'error',2000);
                    }
                }
