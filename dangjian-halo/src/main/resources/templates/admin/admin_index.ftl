                    ...
                    <form class="form-horizontal" id="widgetsOption">
                        <div class="box-body">
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <div class="form-group">
                                    <label for="widgetCommentCount" class="col-sm-4 control-label">
<#--                                        <@spring.message code='admin.index.widgets.comment-count' />-->
                                        专题总数
                                        ：</label>
                                    <div class="col-sm-8 control-radio">
                                        <div class="pretty p-default p-round">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <div class="form-group">
                                    <label for="widgetCommentLastest" class="col-sm-4 control-label">
<#--                                        <@spring.message code='admin.index.widgets.comment-lastest' />-->
                                        最新专题单
                                        ：</label>
                                    <div class="col-sm-8 control-radio">
                                        <div class="pretty p-default p-round">
...
<#--            </#if>-->
            <#if (options.widget_commentcount!'true')=='true'>
                <div class="col-lg-3 col-xs-6" id="widgetCommentCountBody">
                    <div class="small-box bg-green">
                        <div class="inner"><h3><@articleTag method="specialsCount">${specialsCount!0}</@articleTag></h3><p>专题单</p></div>
                        <div class="icon"><i class="ion ion-stats-bars"></i></div>
                        <a data-pjax="true" href="/admin/specials" class="small-box-footer"><@spring.message code='common.btn.view-all' /> <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </#if>
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover text-center">
                            <tbody>
                                ...
                                <#if specialTopFive??>
                                    <#list specialTopFive as post>
                                        <tr>
                                            <#if post.postStatus == 0>
                                                <td><a target="_blank" href="/specials/${post.postUrl}">${post.postTitle}</a></td>
                                            <#else >
                                                <td>${post.postTitle}</td>
                                            </#if>
                                            <td class="text-center">
                                                <#if post.postStatus==0>
                                                    <span class="label bg-green"><@spring.message code='common.status.published' /></span>
                                                <#elseif post.postStatus==1>
                                                    <span class="label bg-yellow">等待审核</span>
                                                <#else>
                                                    <span class="label bg-red">不通过</span>
                                                </#if>
                                            </td>
                                            <td><@common.timeline datetime="${post.postDate!}"?datetime /></td>
                                        </tr>
