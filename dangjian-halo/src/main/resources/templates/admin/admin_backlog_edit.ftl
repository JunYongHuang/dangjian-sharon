                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="general">
                            <form method="post" class="form-horizontal" id="profileForm">
                                <input type="hidden" id="backlogId" name="backlogId" value="${backlog.backlogId?c}">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-sm-8">
                                            <input type="text" class="form-control" id="backlogName" name="backlogName" value="${backlog.backlogName!}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8 control-radio">
                                            <div class="pretty p-default p-round">
                                                <input type="radio" name="backlogStatus" id="backlogStatus" value="0" ${(backlog.backlogStatus==0)?string('checked','')}>
                                                <div class="state p-primary">
                                                    <label>未读</label>
                                                </div>
                                            </div>
                                            <div class="pretty p-default p-round">
                                                <input type="radio" name="backlogStatus" id="backlogStatus" value="1" ${(backlog.backlogStatus==1)?string('checked','')}>
                                                <div class="state p-primary">
                                                    <label>已读</label>
                                                </div>
                                            </div>
                                            <div class="pretty p-default p-round">
                                                <input type="radio" name="backlogStatus" id="backlogStatus" value="1" ${(backlog.backlogStatus==2)?string('checked','')}>
                                                <div class="state p-primary">
                                                    <label>已读5秒以上</label>
                                                </div>
                                            </div>
...
// 			errors.push("姓名 必须为2-4个汉字");
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/backlogs/update',
                async: false,
                data: {
                    'backlogId': $('#backlogId').val(),
                    'backlogName': name,
